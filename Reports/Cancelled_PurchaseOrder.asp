...
<script language="javascript">
	...
	document.Export_PO.action="Report_Cancelled_PurchaseOrder.asp"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td align="center" colspan="3"><font size="4"><b>Cancelled Purchase Order</b></font></td>
  </tr>
  <tr> 
  ...
  <tr> 
      ...
      <table width="90%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#666666">
        <tr> 
          <td align="Center" width="90%" bgcolor="#FFFFFF"> 
            <% Response.write "Cancelled Purchase Orders between <b>" &  FromDate & "</b> and <b>" & ToDate %>
          </td>
	...
	sql = " select distinct dbo.fn_Psystem_PurchaseOrderNo(a.PurOrderNum)as PurOrderNo,b.PurOrderNo as PurOrdNo,b.SupplierName, " & _
		...
		"  '"& FromDate &"' and '"& ToDate &"'  and isPOcancelled = 1 Order by b.PurOrderNo "
