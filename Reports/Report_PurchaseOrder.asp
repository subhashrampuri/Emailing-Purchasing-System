...
<!--#include file="../../includes/main_page_header.asp"-->
	...
	<%
	'sql = " Select distinct dbo.fn_Psystem_PurchaseOrderNo(PurOrderNo) as PurOrderNo,PurOrderNo as PurOrdNo,SupplierName,dbo.fn_Psystem_GetSupplierAddress(SupplierName) as SupplierAddress, " & _ 
	'	" dbo.fn_TSystem_GetVelankaniFormatDate(PurOrderDate) as PurOrderDate from tbl_Psystem_Quotations where PurOrderDate between " & _ 
	'	" '" & FromDate & "' and '" & ToDate & "'  and isClosed = 0 "
	...
	Response.AddHeader "content-disposition","attachment;filename=Purchase_Order_" & FromDate & "_" & ToDate & ".xls"
