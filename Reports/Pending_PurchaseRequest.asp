...
<script language="javascript">
	...
	document.Export_PR.action="Report_Pending_PurchaseRequest.asp"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" colspan="3"><font size="4"><b>Approved Purchase Request</b></font></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	%>
      <table width="90%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#999999">
        <tr bgcolor="#FFFFFF" valign="middle">
          <td colspan="12">
            <div align="center"> <% Response.write "Approved Purchase Requests between <b>" &  FromDate & "</b> and <b>" & ToDate %></div>
          </td>
          <td>
            <div align="center">
        ...
        <tr bgcolor="#FFFFFF" valign="middle">
          ...
          <td>
            <div align="center"><b>Quantity Pending</b></div>
          </td>
          <td>
	...
	sql = " Select dbo.fn_Psystem_PurchaseRequisitionNo(b.RequisitionNum) as RequisitionID,a.ItemDescription,dbo.fn_TimeSheet_GetProjectName(a.ProjectId) as Project, " & _
		...
		" from tbl_Psystem_PurchaseRequestTransaction a,tbl_Psystem_PurchaseRequestMaster b where a.RequisitionId = b.RequisitionId and (a.Status = 2 OR a.Status = 1) " & _
	...
	%>
        <tr bgcolor="#FFFFFF">
          ...
          <td>
            <div align="center"><%=objRs("QuantityApproved")%></div>
          </td>
          <td>
            <div align="center"><%=objRs("QtyPending")%></div>
          </td>
	  ...
	  wend
		...
		Response. Write "<tr><td align='center' bgcolor='#ffffff' Colspan='13'><b>No Records Found</b></td></tr>"
		end if
		set objRs = NOTHING
  %>
      </table>
