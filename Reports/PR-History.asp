...
<script language="javascript">
	...
	document.Export_PR.action="Report_PR-History.asp"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	%>
	      ...
	      <table width="90%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#999999">
            <tr bgcolor="#FFFFFF" valign="middle"> 
              <td colspan="8"> 
                <div align="center"> 
                  <% Response.write "Purchase Requests between <b>" &  FromDate & "</b> and <b>" & ToDate %>
                </div>
              </td>
              <td> 
                <div align="center"> 
  ...
  <tr>
	...
	<input type="hidden" name="hdFromDate" value="<%=FromDate%>">
	<input type="hidden" name="hdToDate" value="<%=ToDate%>">
	<input type="hidden" name="hdEmpID" value="<%=EmployeeID%>">	
	</form>
	</td>
  </tr>
</table>
