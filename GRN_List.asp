...
%>
      ...
      <table width="100%" cellspacing="2" cellpadding="2" border="0">
        <tr height="25" class="blue" align="center">
          <td align="center" colspan="2"> <font color=#ffffff><b>GOODS RECEIVED
            NOTE (GRN)</b></font></td>
        </tr>
        <tr hight="25">
          <td colspan="2">&nbsp;</td>
            ...
            <form name="strFormm">
			  <table cellspaning="2" cellpadding="2" border="0" width="50%" align="center">
                <tr class="blue" align="center">
                  ...
                  <td align="center"><font color="#ffffff"><b>GRN No</b></font></td>
                  <td align="center"><font color="#ffffff"><b>Status</b></font></td>
                </tr>
                <%
					Dim i
					'sql ="Select distinct GRNNo from tbl_PSystem_GRN where isAccepted = 0 and isGRNClosed = 0"
					sql = "Select distinct a.GRNNo,b.RequisitionID,EmployeeID from tbl_Psystem_GRN a,  " & _
						" tbl_Psystem_PurchaseRequestMaster b where a.RequisitionID = b.RequisitionID " & _
						" and b.employeeID = '" & EmployeeId & "' and a.isAccepted = 0 and a.isGRNClosed = 0"
                ...
                <tr bgcolor="<%=gsBGColorLight%>">
                  ...
                  <td align="center"><a href="javascript:redirect(<%=GRNNo%>)"><%=GetGRNNo(GRNNum)%></a></td>
                  <td align="center">GRN Entered</td>
                </tr>
                <%
					i = i + 1
					rsItems.movenext
...
<p align="center">
 ...
 {
 	document.FinalForm.hdGRNNo.value = requestId;
...
<form name="FinalForm">
	<input type="hidden" name="hdGRNNo" value="">
</form>
